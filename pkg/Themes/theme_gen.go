...
func (myTheme) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	...
	case theme.ColorNameBackground:
		return color.NRGBA{R: 0x13, G: 0x0, B: 0x31, A: 0xff}
	case theme.ColorNameButton:
		return color.Alpha16{A: 0x0}
	case theme.ColorNameDisabledButton:
		return color.NRGBA{R: 0x26, G: 0x26, B: 0x26, A: 0xff}
	case theme.ColorNameDisabled:
		return color.NRGBA{R: 0x4b, G: 0x62, B: 0xfe, A: 0xff}
	case theme.ColorNameError:
		return color.NRGBA{R: 0xf4, G: 0x43, B: 0x36, A: 0xff}
	case theme.ColorNameFocus:
		return color.NRGBA{R: 0x73, G: 0x36, B: 0xfc, A: 0x7f}
	...
	case theme.ColorNamePrimary:
		return color.NRGBA{R: 0x22, G: 0xf3, B: 0x27, A: 0xff}
